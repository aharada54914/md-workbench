...
const pl: Translations = {
  ...
  workspaceRenameFailed: "Nie udało się przenieść elementu lub zmienić jego nazwy. Sprawdź, czy nazwa docelowa jest wolna i czy oba foldery umożliwiają zapis.",
  workspaceDeleteFailed: "Nie udało się usunąć elementu. Sprawdź, czy folder umożliwia zapis i czy element nie jest używany.",
  workspaceDeletePartial: "Usuwanie zatrzymało się i część elementów mogła zostać usunięta. Przed ponowną próbą sprawdź odświeżony folder.",
  workspaceDestinationExists: "Element już istnieje w miejscu docelowym. Wybierz inną nazwę lub lokalizację.",
  ...
  updatesDisabled: "Aktualizacje są wyłączone w tej wersji rozwojowej.",
  ...
  qsContentPermissionRequired: 'Wybierz ponownie obszar poleceniem Otwórz obszar, aby przeszukiwać treść.',
  qsContentLimitExceeded: 'Przekroczono limit wyszukiwania treści. Użyj dokładniejszego zapytania lub otwórz mniejszy obszar.',
  qsContentFailed: 'Nie udało się ukończyć wyszukiwania treści. Spróbuj ponownie.',
