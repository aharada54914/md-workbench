...
const en: Translations = {
  ...
  workspaceRenameFailed: "Could not move or rename the item. Check that the destination name is available and both folders are writable.",
  workspaceDeleteFailed: "Could not delete the item. Check that the folder is writable and the item is not in use.",
  workspaceDeletePartial: "Deletion stopped and some items may have been removed. Check the refreshed folder before trying again.",
  workspaceDestinationExists: "An item already exists at the destination. Choose another name or location.",
  ...
  autoSaveOff: 'Off',
  wordWrap: 'Word wrap',
  dropFilesHere: 'Drop documents, images or folders here',
  ...
  qsContentPermissionRequired: 'Select the workspace again using Open workspace to allow content search.',
  qsContentLimitExceeded: 'Content search exceeded a limit. Use a more specific query or open a smaller workspace.',
  qsContentFailed: 'Content search could not finish. Try again.',
