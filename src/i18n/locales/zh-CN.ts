...
const zhCN: Translations = {
  ...
  workspaceRenameFailed: "无法移动或重命名项目。请检查目标名称是否可用，以及源文件夹和目标文件夹是否允许写入。",
  workspaceDeleteFailed: "无法删除项目。请检查文件夹是否允许写入，以及项目是否正被使用。",
  workspaceDeletePartial: "删除操作已停止，部分项目可能已被移除。请检查刷新后的文件夹，再决定是否重试。",
  workspaceDestinationExists: "目标位置已存在同名项目。请选择其他名称或位置。",
  ...
  qsContentPermissionRequired: '请通过“打开工作区”重新选择工作区，以允许搜索内容。',
  qsContentLimitExceeded: '内容搜索超出限制。请使用更具体的关键词或打开较小的工作区。',
  qsContentFailed: '无法完成内容搜索。请重试。',
